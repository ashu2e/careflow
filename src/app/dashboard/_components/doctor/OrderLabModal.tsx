...
export function OrderLabModal({ isOpen, onClose }: OrderLabModalProps) {
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <label className="flex items-center">
                    <input type="radio" name="priority" value="routine" className="text-blue-600 focus:ring-blue-500" defaultChecked />
                    <span className="ml-2 text-sm text-gray-700">Routine</span>
                  </label>
                  <label className="flex items-center">
                    <input type="radio" name="priority" value="stat" className="text-red-600 focus:ring-red-500" />
